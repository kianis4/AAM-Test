# AAM Associate Test — Study Hub

> **Your one-stop reference for test prep.** Everything here is sourced directly from the provided materials — no assumptions, no outside info.
...
- Key takeaway: know the "triple" (30/day, 7:45 a.m., 2 min each)

**Step 2:** Read [04 - Common Objections](04-Common-Objections.md)
...
| What | Number |
| --- | --- |
| Triples per day (Combo) | 30 |
| Time per triple | 2 min or less |
...
| Name | Role | Segment |
| --- | --- | --- |
| Francois Nantel | President, MHCCA | Overall |
| Felix Beauregard | VP, Vendor Finance (Inventory Finance) | Transportation, Construction, Industrial, Inventory |
| Kevin Hall | VP, Equipment Finance (Commercial Finance) | ABL, Direct Finance, Tech & Healthcare, Syndication |
...
3. **Bold key terms** — The important stuff jumps out at you
4. **"Why This Matters" explanations** — Context for why you should care about each fact
5. **Real examples from the materials** — Not hypothetical, pulled directly from the source
6. **Tables for quick reference** — Numbers, comparisons, and lists in easy-to-scan format
7. **Practice Questions & Answers** — Short answer and scenario-based, matching the test format
